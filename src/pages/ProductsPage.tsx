...
const headers = ['Item name', 'Category', 'SKU', 'Dimensions (L×W×H)', 'Quantity', 'Packaging layers count', 'Packaging weight per unit', 'Total packaging weight', 'Average confidence', 'Actions'];
