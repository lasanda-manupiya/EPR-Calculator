...
export default function CreateProductPage({ onSave }: { onSave: (p: Product) => void }) {
  ...
  const est = useMemo(() => estimateProduct({ id: 'draft', name, category, sku, quantity, dimensions, layers }, referenceLibrary), [name, category, sku, quantity, dimensions, layers]);
