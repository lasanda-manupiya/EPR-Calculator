...
export const referenceLibrary: ReferenceItem[] = [
  { id: 'ref-1', referenceName: 'Small cardboard box', materialType: 'Cardboard', packagingType: 'primary', length: 120, width: 90, height: 60, unit: 'mm', averageWeight: 45, densityValue: 0.000069, notes: 'General small retail carton' },
  { id: 'ref-2', referenceName: 'Medium cardboard box', materialType: 'Cardboard', packagingType: 'secondary', length: 250, width: 180, height: 120, unit: 'mm', averageWeight: 180, densityValue: 0.000033, notes: 'Typical shipping carton' },
  { id: 'ref-3', referenceName: 'Large cardboard box', materialType: 'Cardboard', packagingType: 'tertiary', length: 450, width: 350, height: 300, unit: 'mm', averageWeight: 700, densityValue: 0.000015, notes: 'Bulk transport carton' },
  ...
  { id: 'ref-5', referenceName: 'Bubble wrap', materialType: 'Plastic', packagingType: 'secondary', length: 300, width: 300, height: 40, unit: 'mm', averageWeight: 18, densityValue: 0.00005, notes: 'Protective insert' },
